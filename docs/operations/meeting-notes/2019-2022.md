...
**Úkol**: Javorek se sejde s Bílkem na téma jak poskytuje Pyvce finanční podporu např pro PyCon CZ. Poznámky (které byly v době zveřejnění zápisu {ref}`již zpracovány <financni-podpora>`):
...
**Úkol**: Přijímání členů máme {ref}`popsáno v docs.pyvec.org <jak-clenstvi>`, ale je potřeba zdokumentovat poslední přijímání z 28. 9. 2019.
