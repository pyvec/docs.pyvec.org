...
- Placení sídla Pyvce - obstarává firma Ofigo: jednou ročně nám posílá na `info@pyvec.org` fakturu k uhrazení. Taky se stará o příchozí poštu (oskenuje a pošle nám mailem)
